window.onload = function () {
    ...
    document.querySelector("#novo").addEventListener("click", function (event) {
        const itens = document.getElementsByTagName("tbody");
        itens[0].innerHTML += '<tr><td><input type="text" placeholder="Digite o novo aviso" class="new-warn"></td><td></td></tr>';
    });
